...
type AccordionContentProps = ComponentPropsWithoutRef<typeof Collapsible.Content>;
  ...
  (props: ScopedProps<AccordionContentProps>, forwardedRef) => {
    ...
    return (
      <Collapsible.Content
        ...
        {...contentProps}
        style={{
          ["--allygory-accordion-content-height" as never]:
            "var(--allygory-collapsible-content-height)",
          ["--allygory-accordion-content-width" as never]:
