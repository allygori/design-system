...
import type { AriaAttributes, ComponentPropsWithoutRef, ElementRef } from "react";
...
import { ACCORDION_KEYS, ACCORDION_NAME } from "./shared/constants";
import {
  type ScopedProps,
  Collection,
  useCollection,
...
const AccordionRootImpl = forwardRef<AccordionRootImplElement, AccordionRootImplProps>(
...
AccordionRootImpl.displayName = ACCORDION_NAME;
